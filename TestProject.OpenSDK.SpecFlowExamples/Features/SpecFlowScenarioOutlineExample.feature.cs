...
#line hidden
        ...
        public virtual void UserTriesToLogInToTheTestProjectDemoApplication(string firstname, string username, string password, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("User tries to log in to the TestProject demo application", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 7
